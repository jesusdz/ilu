...
static bool GenerateReflex(const Cast *cast, Arena &arena)
{
	...
	printf("\n");
	printf("////////////////////////////////////////////////////////////////////////\n");
	printf("// Generated by reflex from engine.h and game.cpp, do not edit. build.bat rebuilds it.\n");
	printf("//\n");
	printf("// Include it twice, each time with one of these macros defined:\n");
	printf("//\n");
	printf("// REFLEX_GENERATED_DECLARATION: the type ID lists and the meta flag bits. It goes before\n");
	printf("// reflex.h, which expands the ID lists to number every reflected type.\n");
	printf("//\n");
	printf("// REFLEX_GENERATED_IMPLEMENTATION: the reflection data of every type, registered when the\n");
	printf("// program starts. It goes after reflex.h, after every reflected type is declared (the data\n");
	printf("// holds their sizes and member offsets), and after the ops that members name in REFLEX_OPS.\n");
